...
if __name__ == '__main__':
    ...
    is_ok(reactor.__class__.__name__, 'Pyjo_Reactor_Select', 'right object')
    is_ok(Pyjo.Reactor.Select.new().__class__.__name__, 'Pyjo_Reactor_Select', 'right object')
    reactor = None
    is_ok(Pyjo.Reactor.Select.new().__class__.__name__, 'Pyjo_Reactor_Select', 'right object')
    import Pyjo.IOLoop
    ...
    ok(not recurring.get(), 'recurring was not triggered again')
    reactor2 = Pyjo.Reactor.Select.new()
    is_ok(reactor2.__class__.__name__, 'Pyjo_Reactor_Select', 'right object')
    ...
    # Detection
    is_ok(Pyjo.Reactor.detect(), 'Pyjo.Reactor.Select', 'right class')
    ...
    is_ok(Pyjo.IOLoop.singleton.reactor.__class__.__name__, 'Pyjo_Reactor_Select', 'right object')
